...
# ============================================================================
# REFERENCE FILE - From Fufs/homeassistant-addons fork of official deprecated
# Home Assistant TellStick add-on
# Source: https://github.com/Fufs/homeassistant-addons/blob/master/tellstick/data/run.sh
# ============================================================================
# This file is kept for reference only to compare implementations.
# ============================================================================
